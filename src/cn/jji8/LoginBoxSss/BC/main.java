...
public class main extends Plugin implements Listener {
    ...
    public void onPostLogin(PostLoginEvent event) {
        if(peizhi.后台更多信息){System.out.println("玩家"+event.getPlayer().getName()+"连接BC，准备连接到子服务器服务器");}
        ...
        try {
            ...
            if(peizhi.后台更多信息){System.out.println("没有找到"+peizhi.工作路径+"/登入状态/"+event.getPlayer().getName()+".yml文件，他一定是个新玩家吧！");}
            return;
        }
